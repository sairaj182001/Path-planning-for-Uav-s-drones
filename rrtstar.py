...
from queue import QueueFIFO
from sampleutils import Env,Plotting,Utils
...
class RrtStar:
    def __init__(self, x_start, x_goal, step_len,
                 goal_sample_rate, search_radius, iter_max,plot):
...
def main():
    ...
    rrt_star = RrtStar(x_start, x_goal, 1, 0.10, 20, 1500,1)
    rrt_star.planning()
